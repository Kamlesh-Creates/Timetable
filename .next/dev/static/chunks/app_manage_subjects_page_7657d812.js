...
"[project]/app/manage/subjects/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SubjectsPage() {
    ...
    const filtered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SubjectsPage.useMemo[filtered]": ()=>{
            const q = query.toLowerCase();
            return [
                ...subjects
            ].filter({
                "SubjectsPage.useMemo[filtered]": (s)=>s.name.toLowerCase().includes(q)
            }["SubjectsPage.useMemo[filtered]"]).sort({
                "SubjectsPage.useMemo[filtered]": (a, b)=>{
...
_s(SubjectsPage, "1xHVbjeu8rrpq94d9NBOx6aU9Qo=");
_c = SubjectsPage;
var _c;
...
//# sourceMappingURL=app_manage_subjects_page_7657d812.js.map