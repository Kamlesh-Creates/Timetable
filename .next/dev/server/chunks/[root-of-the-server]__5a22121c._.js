...
"[project]/app/api/admin/teachers/[id]/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_request, { params }) {
    ...
    const teacher = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Teacher$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(id).populate("subjects");
    if (!teacher) {
...
async function PUT(request, { params }) {
    ...
    try {
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Teacher$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(id, {
            name,
            email,
            phone,
...
async function DELETE(_request, { params }) {
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectToDatabase"])();
    const { id } = await params;
    const deleted = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Teacher$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndDelete(id);
    if (!deleted) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: "Teacher not found"
        }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5a22121c._.js.map